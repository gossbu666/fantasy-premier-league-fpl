...
# 1) โหลด base data
df = pd.read_csv("data/processed/DEF_data.csv")
df["season"] = df["season"].astype(str)

print(f"Loaded DEF_data.csv: {len(df)} rows")
...
base_feature_cols = [
    ...
    "clean_sheets", "ict_index", "fdr_attack", "fdr_defense", "is_home"
]
...
out.to_csv("data/processed/DEF_features_enhanced_safe.csv", index=False)
print("✅ Saved season-safe DEF features")
