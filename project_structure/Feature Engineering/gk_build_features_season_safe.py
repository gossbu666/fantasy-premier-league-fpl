...
# 1) โหลด base data
df = pd.read_csv("data/processed/GK_data.csv")
df["season"] = df["season"].astype(str)

print(f"Loaded GK_data.csv: {len(df)} rows")
...
base_feature_cols = [
    ...
    "assists", "bps", "influence", "saves", "goals_conceded",
...
out.to_csv("data/processed/GK_features_enhanced_safe.csv", index=False)
print("✅ Saved season-safe GK features")
